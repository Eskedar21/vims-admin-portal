...
export const mockAuditEvents = [
  {
    ...
    source: 'admin-portal', // 'desktop-app' or 'admin-portal'
  },
  {
  ...
  // Desktop App Actions
  {
    audit_event_id: 'AUD-005',
    event_type: 'inspection_started',
    actor_user_id: 'inspector-001',
    actor_role_id: 'inspector',
    actor_scope_type: 'Center',
    actor_scope_ids: ['CTR-001'],
    target_type: 'inspection',
    target_id: 'INS-100',
    action: 'create',
    before_snapshot: null,
    after_snapshot: { inspection_id: 'INS-100', status: 'in_progress' },
  ...
  },
  {
    ...
    after_snapshot: { status: 'completed', result: 'pass' },
  ...
  },
  {
    ...
    action: 'create',
    before_snapshot: null,
    after_snapshot: { payment_id: 'PAY-100', amount: 402.50, method: 'TeleBirr' },
