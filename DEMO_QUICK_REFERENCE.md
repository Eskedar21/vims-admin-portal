...
- ✅ Recent inspections table (searchable)
...
### Inspections
- ✅ Search: Plate, VIN, Chassis, Inspector
- ✅ Machine tests: Read-only (locked)
- ✅ Evidence: Photos, Video, Location
- ✅ Print/Export: PDF, CSV

### Center Management
- ✅ Multi-tab: Centers/Users/Machines
- ✅ Geofence: Interactive map drawing
- ✅ Device registry: Machine tracking
- ✅ Camera settings: Recording config
...
### Configuration
- ✅ Test standards: Pass/fail thresholds
- ✅ Checklists: 30-point customization
- ✅ Fees: Base + VAT + Regional overrides

### Governance
- ✅ Hierarchical structure (National → Center)
- ✅ Role assignments
...
- ✅ Role assignment
- ✅ Scope filtering (National/Regional/Center)

### Security
- ✅ Audit logs: All actions tracked
- ✅ Filter: Date, User, Action, IP
- ✅ Export: CSV
- ✅ Security alerts
...
|------|-----------|------------|---------|---------|--------|-------|----------|
| Super Admin | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| Regional Admin | ✅ | ✅ | ✅ (Scoped) | ✅ (Scoped) | ❌ | ❌ | ❌ |
| Center Manager | ✅ | ✅ | ✅ (Own) | ✅ (Scoped) | ❌ | ❌ | ❌ |
| Inspector | ✅ | ❌ | ❌ | ✅ (Scoped) | ❌ | ❌ | ❌ |
| Viewer | ✅ | ❌ | ❌ | ✅ (Scoped) | ❌ | ❌ | ❌ |
